    ...
    <div class="col-md-6 col-lg-4 col-xl-3 mb-5">
        <div class="card shadow-lg rounded-card h-100">
            ...
            <div class="d-flex justify-content-center mt-2 mb-4">
                <a href="${`#/detail-article/${contentArticles._id}`}" onclick="window.scrollTo(0, 0);"><button type="button" class="btn btn-outline-green px-3 py-2" tabindex="-1">Baca selengkapnya</button></a>
            </div>
        </div>
     </div>
...
const createContentEventTemplate = (contentEvents) => `
    <div class="col-md-6 col-lg-4 col-xl-3 mb-5">
        <div class="card shadow-lg rounded-card h-100">
            ...
            <div class="d-flex justify-content-center mt-2 mb-4">
                <a href="${`#/detail-event/${contentEvents._id}`}" onclick="window.scrollTo(0, 0);"><button type="button" class="btn btn-outline-green px-3 py-2" tabindex="-1">Baca selengkapnya</button></a>
            </div>
        </div>
    </div>
`;
    ...
    skeletonTemplate += `
      <div class="col-md-6 col-lg-4 col-xl-3 mb-5">
        <div class="card skeleton shadow-lg rounded-card h-100">
            ...
            <div class="d-flex justify-content-center mt-2 mb-4">
            <a href="#/skeleton-detail-article" onclick="window.scrollTo(0, 0);"><button type="button" class="btn btn-outline-green px-3 py-2" tabindex="-1">Baca selengkapnya</button></a>
            </div>
        </div>
     </div>
      `;
    ...
    <div class="col-md-6 col-lg-4 col-xl-3 mb-5">
        <div class="card skeleton shadow-lg rounded-card h-100">
            ...
            <div class="card-body px-4">
                ...
                <p class="card-text fw-normal mb-0"><i class="fa fa-tags me-1"></i>Kategori</p>
            </div>
            <div class="d-flex justify-content-center mt-2 mb-4">
                <a href="#/skeleton-detail-event" onclick="window.scrollTo(0, 0);"><button type="button" class="btn btn-outline-green px-3 py-2" tabindex="-1">Baca selengkapnya</button></a>
            </div>
        </div>
    </div>
        `;
...
const createAfterLoadingText = (err) => `  
    <p class="text-danger fw-bolder ms-2"><i class="fa fa-warning me-1"></i>${err}</p>
`;
